...
class OpenMlDataset():
    def __init__(self, dataset_id, threshold = 0.9, normalization_type="standard", split=0.75) -> None:
        ...
        normalization_type: "standard" or "robust"
            How to normalize numeric attributes. Standard will set average to 0 and std to 1. Robust will use remove median and scale according to quantile range.

        split: float
            Value between 0.0-1.0. It is used to determine what % of the whole data will be used as training. Rest will be used as test data.
    ...
    def get_predictors(self):
        ...
        pred_categorical_indicator: list[Bool]
            List of True/False indicator, which parameter is numeric or categorical. Length is the same as training_pred_data.shape[1].
        """
    ...
    def get_targets(self):
        ...
        pred_categorical_indicator: list[Bool]
            List of True/False indicator, which parameter is numeric or categorical. Length is the same as training_tar_data.shape[1].
        """
    ...
    def get_test_predictors(self):
        ...
        pred_categorical_indicator: list[Bool]
            List of True/False indicator, which parameter is numeric or categorical. Length is the same as test_pred_data.shape[1].
        """
    ...
    def get_test_targets(self):
        ...
        pred_categorical_indicator: list[Bool]
            List of True/False indicator, which parameter is numeric or categorical. Length is the same as test_tar_data.shape[1].
        """
...
class PredictorsPreprocessingModule():
    ...
    def transform_2_value_numeric_to_binary(self):
        """Function will over all numeric attributes and convert them to binary if particular parameter has only 2 unique values.
    ...
    def check_for_values_with_one_occurance(self):
        """Function will look for categorical attributes, which has one occurence of particular value. It will be remove this attribute.
    ...
    def check_for_single_value_parameters(self):
        """Function will look for attribute with one unique value. This attribute is seen as just a constant, so it can be removed.
    ...
    def check_for_pseudocorrelation(self):
        """Function will look for pairs of 2 categorical attributes, which are pseudo-correlated. If the number of unique pairs is the same as number of unique values of one attribute (with higher number out of two)
        , then remove other attribute. It means, that one value in pair can be seen as constant and doesn't provide more information.
    ...
    def check_for_correlation(self):
        """Function will look for pair of 2 numeric features. If the absolute value of their correlation score is than threshold, then removed parameter with less unique values.
    ...
    def normalize_dataset(self):
        """Function will normalize all numeric attributes with standard or robust method. Decision is based on self.normalization_type.
    ...
    def one_hot_encoding(self, x):
        """Function will convert categorical attribute into one-hot encoding. Binary attributes will be coded using 1 neuron. The rest will be encoded using n neurons, where n is the number of unique values.
    ...
    def dataset_one_hot_encoding(self):
        """Function will convert categorical attributes into one-hot encoding. Binary attributes will be coded using 1 neuron. The rest will be encoded using n neurons, where n is the number of unique values.
